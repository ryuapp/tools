...
const content = {
  en: {
    title: "SVG Converter",
    description: "Convert SVG to PNG with custom dimensions",
    ...
    errorConversion: "Failed to convert SVG to PNG",
    preview: "Preview",
    settings: "Settings",
  },
  ja: {
    title: "SVG変換",
    description: "SVGをPNGに変換（サイズ指定可能）",
    ...
    errorConversion: "SVGからPNGへの変換に失敗しました",
    preview: "プレビュー",
    settings: "設定",
  },
};
